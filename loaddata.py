...
def readData(test_size):
    ...
    for name in domains:
        # data = sio.loadmat('OC10_vgg6/' + name + '.mat')  # source domain machine learning\OC10_vgg6\amazon.mat
        data = sio.loadmat('machine learning/OC10_vgg6/'+ name + '.mat')  # source domain
